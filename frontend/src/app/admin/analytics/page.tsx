      ...
      {summary && (
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <Card className="p-4 space-y-2">
            ...
            <p className="text-2xl font-bold text-ink">{formatPrice(summary.totalRevenue)}</p>
          </Card>
          <Card className="p-4 space-y-2">
          ...
          <Card className="p-4 space-y-2">
            ...
            <p className="text-2xl font-bold text-ink">{formatPrice(summary.averageOrderValue)}</p>
          </Card>
        </div>
      )}
              ...
              {bestSellers.length === 0 ? (
                ...
                bestSellers.map((b) => (
                  <tr key={b.productId} className="hover:bg-bg-subtle/40">
                    ...
                    <td className="px-4 py-3 text-right font-medium text-ink">{formatPrice(b.revenue)}</td>
                  </tr>
                ))
              )}
            </tbody>
