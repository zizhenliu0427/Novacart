          ...
          <Card className="p-5 space-y-4">
            ...
            <div className="divide-y divide-border max-h-48 overflow-y-auto">
              {cart.items.map((item) => (
                <div key={item.id} className="py-2.5 flex justify-between gap-3 text-sm">
                  ...
                  <span className="tnum font-semibold text-ink shrink-0">{formatAud(item.lineTotal)}</span>
                </div>
              ))}
            </div>
            ...
            <div className="border-t border-border pt-4 space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="tnum font-medium text-ink">{formatAud(subtotal)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-ink-muted">Shipping</span>
                <span className="tnum font-medium text-ink">{shipping === 0 ? 'Free' : formatAud(shipping)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-ink-muted">Estimated Tax (10% GST)</span>
                <span className="tnum font-medium text-ink">{formatAud(tax)}</span>
              </div>
            </div>

            <div className="border-t border-border pt-4 flex justify-between text-base font-bold text-ink">
              <span>Total</span>
              <span className="tnum">{formatAud(total)}</span>
            </div>
            ...
            <CurrencyDisclaimer className="text-center" />
