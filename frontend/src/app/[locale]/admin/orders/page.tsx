                    ...
                    <tbody className="divide-y divide-border">
                      {detail.items.map((item) => (
                        <tr key={item.id}>
                          ...
                          <td className="px-3 py-2 text-right text-ink-muted tnum">{formatAud(item.price)}</td>
                          <td className="px-3 py-2 text-right text-ink-muted tnum">{item.quantity}</td>
                          <td className="px-3 py-2 text-right font-medium text-ink tnum">{formatAud(item.lineTotal)}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
