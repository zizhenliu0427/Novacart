...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Novacart.Api.Messaging.Saga.OrderCheckoutState", b =>
                {
                    b.Property<Guid>("CorrelationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("PublishDownstream")
                    ...
                    b.HasIndex("OrderId")
                        .HasDatabaseName("idx_order_checkout_sagas_order_id");

                    b.ToTable("order_checkout_sagas", (string)null);
                });

            modelBuilder.Entity("Novacart.Api.Models.Entities.ProcessedStockOrder", b =>
                {
                    b.Property<Guid>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Novacart.Api.Models.Entities.OrderStatusHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Novacart.Api.Models.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
